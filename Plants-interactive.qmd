...
plants <- st_read("./data/solidago_presences/solidago_presences.shp", quiet = TRUE) |>
  group_by(CmbndID) |>
  summarize(
...
```{r Generate convex hulls over clusters identified by DBSCAN}
